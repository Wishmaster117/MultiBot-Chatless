...
local enUSValues = {
  ...
  ["inventory.bank.count"] = "bank item(s)",
  ...
  ["info.inventory.item_action.reason.BOT_NOT_IN_GUILD"] = "The bot is not in a guild.",
  ["info.inventory.item_action.reason.BANKER_NOT_FOUND"] = "No banker nearby.",
  ["info.inventory.item_action.reason.BANK_FULL"] = "The bot bank is full.",
  ["info.inventory.item_action.reason.BAGS_FULL"] = "The bot bags are full.",
  ["info.inventory.item_action.reason.GUILD_BANK_NOT_FOUND"] = "No guild bank nearby.",
  ["info.inventory.item_action.reason.NOT_IN_SAME_GUILD"] = "The bot is not in your guild.",
  ["info.inventory.item_action.reason.NO_GUILD_BANK_RIGHTS"] = "The bot cannot deposit into the first guild bank tab.",
  ["info.inventory.item_action.reason.NO_GUILD_BANK_RIGHTS"] = "The bot does not have the required guild bank rights.",
  ["info.inventory.item_action.reason.GUILD_BANK_FULL"] = "The guild bank did not accept the item.",
  ...
  ["info.inventory.item_action.reason.VENDOR_REQUIRES_SPECIAL_CURRENCY"] = "The vendor requires another currency or item, not coins.",
  ["info.inventory.item_action.reason.VENDOR_DOES_NOT_SELL_ITEM"] = "No nearby vendor sells this item.",
  ["info.inventory.item_action.reason.NOT_ENOUGH_MONEY"] = "The bot does not have enough money.",
  ["info.inventory.item_action.reason.BUY_FAILED"] = "The purchase failed.",

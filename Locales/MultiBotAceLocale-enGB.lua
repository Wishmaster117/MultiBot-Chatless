...
["info.inventory.item_use.reason.UNKNOWN"] = "The server returned an unknown item-use error.",
  ...
  ["tips.format.shield"] = "Shield Formation\n|cffffffffBots line up in the front, on the left and right side, facing and aligned in your direction.|r\n\n|cffff0000Left-click to select|r\n|cff999999(Executed by: Raid, Party)|r",
   ["tips.format.far"] = "Far Formation\n|cffffffffBots stay free while they remain nearby.\nIf they move too far away, they return to you.|r\n\n|cffff0000Left-click to select|r\n|cff999999(Executed by: Raid, Party)|r",
  ...
  ["tips.creator.init"] = "Automatic initialization\n|cffffffffAutomatically initializes eligible AddClass bots according to Playerbots rules.\nWarning: the bot's existing equipment will be replaced.|r\n\n|cffff0000Left-click: initialize the target if it is an eligible AddClass bot|r\n|cff999999(Execution order: Target)|r\n\n|cffff0000Right-click: scan the group/raid and initialize eligible AddClass bots|r\n|cff999999(Execution order: Raid, Party)|r",
  ["tips.unit"] = "",
  ...
  ["tips.units.favorites"] = "Favorites|cffffffff\nShows bots explicitly marked as favourites.|r",
  ...
  ["spellbook.cast.success.target"] = "[MultiBot] %s casts %s on %s.",
  ["spellbook.cast.success.self"] = "[MultiBot] %s casts %s.",
  ["spellbook.cast.failed"] = "[MultiBot] %s cannot cast %s: %s.",
  ["spellbook.cast.reason.BAD_REQUEST"] = "invalid request",
  ["spellbook.cast.reason.BRIDGE_REQUIRED"] = "the Bridge is not connected",
  ["spellbook.cast.reason.CAPABILITY_UNAVAILABLE"] = "the Spellbook cast service is unavailable",
  ["spellbook.cast.reason.TOO_MANY_REQUESTS"] = "too many requests are pending",
  ["spellbook.cast.reason.SEND_FAILED"] = "the request could not be sent",
  ["spellbook.cast.reason.TIMEOUT"] = "no confirmation was received",
  ["spellbook.cast.reason.NO_SESSION"] = "the player session is unavailable",
  ["spellbook.cast.reason.RATE_LIMIT"] = "too many requests were sent",
  ["spellbook.cast.reason.REPLAY"] = "duplicate request",
  ["spellbook.cast.reason.NO_BOT"] = "the bot could not be found",
  ["spellbook.cast.reason.SELF_NOT_ALLOWED"] = "this action is not available for the player",
  ["spellbook.cast.reason.BOT_UNAVAILABLE"] = "the bot is not available in the world",
  ["spellbook.cast.reason.NO_AI"] = "the bot AI is unavailable",
  ["spellbook.cast.reason.FORBIDDEN"] = "you are not allowed to control this bot",
  ["spellbook.cast.reason.SPELL_NOT_ALLOWED"] = "this spell is not available in the bot's Spellbook",
  ["spellbook.cast.reason.BAD_SPELL"] = "invalid or passive spell",
  ["spellbook.cast.reason.UNSUPPORTED_TARGET"] = "this type of spell target is not supported",
  ["spellbook.cast.reason.TRADE_ACTIVE"] = "the bot is trading",
  ["spellbook.cast.reason.PET_SPELL_NOT_ALLOWED"] = "pet spells are not handled by this Spellbook",
  ["spellbook.cast.reason.LOST_CONTROL"] = "the bot has lost control",
  ["spellbook.cast.reason.IN_FLIGHT"] = "the bot is in flight",
  ["spellbook.cast.reason.CHANNELING"] = "the bot is already channeling a spell",
  ["spellbook.cast.reason.NOT_READY"] = "the spell is not ready",
  ["spellbook.cast.reason.MOVING"] = "the bot must stop moving",
  ["spellbook.cast.reason.CANNOT_CAST"] = "the spell cannot be cast right now",
  ["spellbook.cast.reason.CAST_FAILED"] = "the cast did not start",
  ["spellbook.cast.reason.REQUIRES_SPELL_FOCUS"] = "a required spell focus is missing",
  ["spellbook.cast.reason.REQUIRES_AREA"] = "the spell cannot be cast in this area",
  ["spellbook.cast.reason.MISSING_TOOLS"] = "required tools are missing",
  ["spellbook.cast.reason.NO_MATERIALS"] = "required reagents or materials are missing",
  ["spellbook.cast.reason.NOT_STANDING"] = "the bot must be standing",
  ["spellbook.cast.reason.OUT_OF_RANGE"] = "the target is out of range",
  ["spellbook.cast.reason.NO_TRADE"] = "a trade window is required",
  ["spellbook.cast.reason.ALREADY_ENCHANTED"] = "the item is already enchanted",
  ["spellbook.cast.reason.NOT_TRADEABLE"] = "the target item cannot be traded",
  ["spellbook.cast.reason.BAD_TARGET"] = "invalid target",
  ["spellbook.cast.reason.IN_COMBAT"] = "the spell cannot be cast in combat",
  ["spellbook.cast.reason.TRY_AGAIN"] = "try again",
  ["spellbook.cast.reason.UNKNOWN"] = "the spell could not be cast",
  ["spellbook.ignore.failed"] = "[MultiBot] %s could not change the ignored state of %s: %s.",
  ["spellbook.ignore.success.added"] = "[MultiBot] %s: spell %s added to the ignored spell list.",
  ["spellbook.ignore.success.removed"] = "[MultiBot] %s: spell %s removed from the ignored spell list.",
  ["spellbook.ignore.filter.ignored"] = "Ignored (%d)",
  ["spellbook.ignore.filter.all"] = "All spells",
  ["spellbook.ignore.filter.ignored.tooltip"] = "Show only spells this bot should not use.",
  ["spellbook.ignore.filter.all.tooltip"] = "Show all spells known by this bot.",
  ["spellbook.ignore.reason.BAD_REQUEST"] = "invalid request",
  ["spellbook.ignore.reason.BRIDGE_REQUIRED"] = "the Bridge is not connected",
  ["spellbook.ignore.reason.CAPABILITY_UNAVAILABLE"] = "the Spellbook ignore service is unavailable",
  ["spellbook.ignore.reason.TOO_MANY_REQUESTS"] = "too many requests are pending",
  ["spellbook.ignore.reason.SEND_FAILED"] = "the request could not be sent",
  ["spellbook.ignore.reason.TIMEOUT"] = "no confirmation was received",
  ["spellbook.ignore.reason.NO_SESSION"] = "the player session is unavailable",
  ["spellbook.ignore.reason.RATE_LIMIT"] = "too many requests were sent",
  ["spellbook.ignore.reason.REPLAY"] = "duplicate request",
  ["spellbook.ignore.reason.NO_BOT"] = "the bot was not found",
  ["spellbook.ignore.reason.SELF_NOT_ALLOWED"] = "this action is not available for the player",
  ["spellbook.ignore.reason.BOT_UNAVAILABLE"] = "the bot is not available in the world",
  ["spellbook.ignore.reason.NO_AI"] = "the bot AI is unavailable",
  ["spellbook.ignore.reason.FORBIDDEN"] = "you are not allowed to control this bot",
  ["spellbook.ignore.reason.NO_CONTEXT"] = "the bot AI context is unavailable",
  ["spellbook.ignore.reason.SPELL_NOT_ALLOWED"] = "this spell is not available in the bot's Spellbook",
  ["spellbook.ignore.reason.FAILED"] = "the ignored state could not be changed",
  ["spellbook.ignore.reason.UNKNOWN"] = "the ignored state could not be changed",
  ...
  ["tips.hunter.pet.call"] = "Call current pet\n|cffffffffCalls the Hunter's currently saved pet.|r\n\n|cffff0000Left-click to call|r\n|cff999999(Execution Order: Bot)|r",
  ["tips.hunter.pet.dismiss"] = "Dismiss current pet\n|cffffffffTemporarily dismisses the current pet without abandoning it. It can be called again later.|r\n\n|cffff0000Left-click to dismiss|r\n|cff999999(Execution Order: Bot)|r",
  ["tips.hunter.pet.abandon"] = "Abandon current pet\n|cffffffffPermanently abandons the current pet.|r\n\n|cffff0000Left-click to abandon|r\n|cff999999(Execution Order: Bot)|r",
  ...
  ["tips.rogue.dps.dps"] = "Specialization|cffffffff\nEnables the combat strategy matching the Rogue's specialization.|r\n\n|cffff0000Left-click to toggle the specialization strategy|r\n|cff999999(Executed by: Bot)|r",
  ...
  ["info.outfits.reset_sent"] = "Delete command sent to bot.",
  ...
  ["info.outfits.feedback_reset"] = "Outfit \"%s\" deleted.",
  ...
  ["info.outfits.command_failed"] = "Outfit action failed.",
  ["info.outfits.list_timeout"] = "Outfit list request timed out.",
  ["info.outfits.command_timeout"] = "Outfit action timed out.",
  ["info.outfits.disconnected"] = "Outfit bridge disconnected.",
  ...
  ["autogear.button_tip"] = "Choose Autogear options and item level for this bot.",
  ["autogear.defaults"] = "Server values",
  ["autogear.quality"] = "Quality",
  ["autogear.match"] = "Match my item level",
  ["autogear.ilvl"] = "Custom item level",
  ["autogear.limits"] = "Server limits: %s / item level %s",
  ["autogear.unlimited"] = "unlimited",
  ["autogear.reset"] = "Reset equipped gear",
  ["autogear.prepare"] = "Review and confirm",
  ["autogear.loading"] = "Reading server limits...",
  ["autogear.preparing"] = "Checking bot and options...",
  ["autogear.running"] = "Applying Autogear...",
  ["autogear.note"] = "Item level is a generation target. Existing stronger gear may remain without reset.",
  ["autogear.reset_note"] = "Reset permanently deletes equipped combat gear before generating replacements. Shirt and tabard are kept.",
  ["autogear.confirm"] = "%s\nQuality: %s\nItem level target: %s\n%s",
  ["autogear.normal"] = "Upgrade existing gear.",
  ["autogear.invalid"] = "Enter a whole item level from 6 to 99999.",
  ["autogear.unavailable"] = "Autogear options unavailable. Reconnect after updating the bridge.",
  ["autogear.failed"] = "Autogear refused: %s",
  ["autogear.ready"] = "Choose options, then review the server's plan.",
  ["autogear.timeout"] = "No server reply. Reopen this panel to request fresh limits.",
  ["autogear.unknown"] = "No final reply: gear may already have changed. Check the bot's equipment before requesting another Autogear.",
  ["autogear.completed"] = "Autogear finished: %d slots changed, %d empty combat slots.",
  ["autogear.busy"] = "An Autogear request is already pending.",
  ["autogear.expired"] = "Plan expired. Review a new plan.",
  ["autogear.accept_reset"] = "Reset gear",
  ["autogear.accept"] = "Apply",
  ["autogear.cancel"] = "Cancel",
  ["autogear.reason.NO_BOT"] = "Bot unavailable.",
  ["autogear.reason.FORBIDDEN"] = "You cannot control this bot.",
  ["autogear.reason.NOT_IN_WORLD"] = "Bot is not in the world.",
  ["autogear.reason.DEAD"] = "Bot is dead.",
  ["autogear.reason.IN_COMBAT"] = "Bot is in combat.",
  ["autogear.reason.LEVEL_TOO_LOW"] = "Bot must be at least level 5.",
  ["autogear.reason.DISABLED"] = "Disabled by server configuration.",
  ["autogear.reason.ALT_BOT_REFUSED"] = "Autogear is disabled for altbots.",
  ["autogear.reason.BAD_CONFIG"] = "Server configuration is invalid.",
  ["autogear.reason.NO_REFERENCE_GEAR"] = "No equipped items to calculate your item level.",
  ["autogear.reason.BAD_ARGUMENT"] = "Invalid option.",
  ["autogear.reason.PLAN_EXPIRED"] = "Plan expired.",
  ["autogear.reason.TARGET_CHANGED"] = "Bot or equipped gear changed. Review a new plan.",
  ["autogear.reason.PLAN_CHANGED"] = "Limits or reference gear changed. Review a new plan.",
  ["autogear.reason.COOLDOWN"] = "Wait 10 seconds before trying again.",
  ["autogear.reason.RATE_LIMIT"] = "Too many requests. Wait a few seconds.",
  ["autogear.reason.BUSY"] = "Server busy.",
  ["autogear.reason.EXECUTION_FAILED"] = "Execution failed; gear may have changed. Check it before trying again.",
